파마-프렌치 3 팩터 모델은 CAPM에서 사용한 리스크 원천에 기업의 **상대적 규모(relative size)**와 **가치(value)**를 추가한 것이고, 5 팩터 모델은 여기에 **기업 이익(firm profitability)**과 **투자 수준(level of investment)**을 포함하여 확장한 것이다. 
